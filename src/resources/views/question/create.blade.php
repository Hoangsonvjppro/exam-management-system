        ...
        <div class="mb-10 flex items-end justify-between">
            <div>
                <nav class="flex items-center gap-2 text-on-surface-variant text-xs mb-2">
                    ...
                    <span class="material-symbols-outlined text-[14px]">chevron_right</span>
                    <span class="text-primary font-semibold">Tạo câu hỏi</span>
                </nav>
                <h1 class="text-3xl font-extrabold text-primary tracking-tight font-headline">Thêm câu hỏi mới</h1>
                <p class="text-on-surface-variant font-body mt-1">Xây dựng kho tri thức cho hệ thống giáo dục</p>
            </div>
        </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <label class="relative flex items-center cursor-pointer group">
                            <input class="peer sr-only" name="difficulty" type="radio" value="{{ $difficulty->code }}" {{ old('difficulty', 'remember') === $difficulty->code ? 'checked' : '' }} />
