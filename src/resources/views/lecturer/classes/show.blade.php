            ...
            return {
                ...
                async submitQuickExamForm(formElement) {
                    ...
                    try {
                        ...
                        if (!examId) {
                            window.dispatchEvent(new CustomEvent('toast', {
                                detail: { message: 'Không thể tạo đề thi nhanh. Vui lòng thử lại với trình tạo đầy đủ.', type: 'error' }
                            }));
                            return;
                        }
                        ...
                        window.dispatchEvent(new CustomEvent('toast', {
                            detail: { message: 'Đã tạo đề thi mới và tự động chọn vào lịch thi.', type: 'success' }
                        }));
                    } catch (error) {
                        window.dispatchEvent(new CustomEvent('toast', {
                            detail: { message: 'Không thể tạo đề thi nhanh. Vui lòng kiểm tra dữ liệu đầu vào.', type: 'error' }
                        }));
                    } finally {
