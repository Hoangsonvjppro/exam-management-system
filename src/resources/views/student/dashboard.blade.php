        ...
        <div class="bg-white border-[0.5px] border-[#D6E2F0] rounded-[10px]">
            ...
            <div class="p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                    ...
                    $cardStatusText = 'Lưu trữ';
                    $cardStatusClass = 'bg-[#F4F7FC] text-[#6B7C99] border-[0.5px] border-[#D6E2F0]';
                    } elseif ($section->status === 'cancelled') {
                    $cardStatusText = 'Đã huỷ';
                    $cardStatusClass = 'bg-[#FEE2E2] text-[#991B1B] border-[0.5px] border-[#FCA5A5]';
                    } elseif ($semesterLifecycle === \App\Models\Semester::STATUS_UPCOMING) {
                    $cardStatusText = 'Sắp mở';
                    $cardStatusClass = 'bg-[#FEF3C7] text-[#92400E] border-[0.5px] border-[#FCD34D]';
                    } elseif ($semesterLifecycle === \App\Models\Semester::STATUS_CURRENT) {
                    $cardStatusText = 'Đang diễn ra';
                    $cardStatusClass = 'bg-[#E1F5EE] text-[#065F46] border-[0.5px] border-[#9FE1CB]';
                    } elseif ($semesterLifecycle === \App\Models\Semester::STATUS_ENDED) {
                    $cardStatusText = 'Đã kết thúc';
                    $cardStatusClass = 'bg-[#E2E8F0] text-[#334155] border-[0.5px] border-[#CBD5E1]';
                    } else {
                    ...
                    <a href="{{ route('student.classes.show', $section) }}"
                        ...
                        <div class="px-4 py-3 bg-[#F4F7FC] border-b-[0.5px] border-[#D6E2F0]">
                            <div class="flex items-start justify-between gap-2">
                                ...
                                <span class="uppercase text-[10px] font-bold px-2 py-0.5 rounded-[4px] shrink-0 {{ $cardStatusClass }}">
                                    {{ $cardStatusText }}
                                </span>
                            </div>
                        </div>
