                    ...
                    <div x-data="{ loading: false }">
                        <form action="{{ route('student.exams.start', $schedule->id) }}" 
                            ...
                            <button type="submit" 
                                    ...
                                    class="inline-flex items-center px-8 py-3 bg-navy-900 border border-transparent rounded-[8px] font-semibold text-[14px] text-white tracking-wide hover:bg-navy-950 transition shadow-sm">
                                ...
                                <span x-text="loading ? 'Đang khởi tạo...' : '{{ $pastAttempts->isNotEmpty() ? '🔄 Thi lại lần ' . ($pastAttempts->first()->attempt_number + 1) : '▶️ Bắt đầu làm bài' }}'">
